...
- Press [Insert] to bring up the in-game settings menu. Be warned it is poorly implemented. When this project has matured a bit more, it might be used to change gpu clocks and fan speeds while in-game.
